...
const parseHealthCheckRating = (
  ...
  // console.log(`is number :: ${healthCheckRating}`);
  // console.log(`is number :: ${ typeof healthCheckRating}`);

  // console.log(isNumber(healthCheckRating));
  // console.log(isHealthCheckRating(healthCheckRating as number)); 
